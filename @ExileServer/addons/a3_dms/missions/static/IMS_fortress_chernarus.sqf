...
// Add a waypoint.
private _wp1 = _group1 addWaypoint [[6890.78,11372,0.00717163],0];
...
[_group2, [6883.66,11382.8,0], _difficulty, "SAFE"] call DMS_fnc_SetGroupBehavior;
...
// Add a waypoint.
private _wp2 = _group2 addWaypoint [[6894.79,11390.2,-0.00527954],0];
...
[_group3, [6870.17,11404.9,0], _difficulty, "SAFE"] call DMS_fnc_SetGroupBehavior;
...
// Add a waypoint.
private _wp3 = _group3 addWaypoint [[6862.46,11396,2.99701],0];
...
// Set fourth group formation. 
//_group4 setFormation "COLUMN";
// Add a waypoint.
private _wp4 = _group4 addWaypoint [[6873.27,11472.9,0.0291138],0];
...
// Add a waypoint.
private _wp5 = _group5 addWaypoint [[6901.11,11499.4,0.00866699],0];
...
// Add a waypoint.
private _wp6 = _group6 addWaypoint [[6925.57,11448.2,4.75452],0];
...
// Add a waypoint.
private _wp7 = _group7 addWaypoint [[6926.11,11388.9,0.00775146],0];
...
[_group9, [6887.5,11447.7,0], _difficulty, "SAFE"] call DMS_fnc_SetGroupBehavior;
...
// Add a waypoint.
private _wp9 = _group9 addWaypoint [[6887.5,11447.7,0],0];
...
[_groupPatrol, [6902.53,11402.6,0.00708008], _difficulty, "SAFE"] call DMS_fnc_SetGroupBehavior;
...
// Add a waypoint.
private _wpHeli = _groupHeli addWaypoint [[6895.07,11432.1,0],0];
