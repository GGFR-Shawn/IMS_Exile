...
[
	...
	["B_CargoNet_01_ammo_F", [6929.78, 11375.3, 394.021], [-0.991943, -0.126684, 0], [0, 0, 1], false, "Investigate bomb", "inspect", "_this distance _target < 5", {remoteExec ["IMS_Fortress_Bomb_ActionScript", 0, true];}, "FortressBomb_3"],
	["B_CargoNet_01_ammo_F", [6846.95, 11480.8, 391.857], [0.787484, 0.616335, 0], [0, 0, 1], false, "Investigate bomb", "inspect", "_this distance _target < 5", {remoteExec ["IMS_Fortress_Bomb_ActionScript", 0, true];}, "FortressBomb_4"],
	["B_CargoNet_01_ammo_F", [6890.4, 11411.5, 394.84], [0.171482, 0.985187, 0], [0, 0, 1], false, "Investigate bomb", "inspect", "_this distance _target < 5", {remoteExec ["IMS_Fortress_Bomb_ActionScript", 0, true];}, "FortressBomb_5"]
]
