...
[_pinCode] remoteExec ["IMS_Toast_VehicleLoot", _playerUnits, true];
...
// Create the paractute for the vehicle.
_paracute = "B_Parachute_02_F" createVehicle [0, 0, 10000];
// Attach the vehicle dummy to the paracute.
_vehObj attachTo [_paracute,[0,0,-1]];
_paracute setPos [_position select 0, _position select 1, _height];
// Create chemlight.
