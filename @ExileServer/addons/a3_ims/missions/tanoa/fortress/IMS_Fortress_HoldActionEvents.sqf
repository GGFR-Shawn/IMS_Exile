...
IMS_Fortress_Terminal_ActionScript = {
	...
	if (IMS_Fortress_VehicleLoot) then {
		...
		[IMS_Fortress_VehicleLootClass, [12137,2245.81,0], 150, _pincode, "Fortress Vehicle"] call IMS_fnc_SpawnPersistentVehicle;
	};
	// Spawn mission loot drop.
	[[12137,2245.81,0], "B_supplyCrate_F", "Fortress Loot"] call IMS_fnc_LootDrop;
};
