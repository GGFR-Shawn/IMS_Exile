...
fortressRaid_terminal_ActionScript = {
	...
	sleep 3;
	// Start timer
	[IMS_FortressTimer] remoteExec ["exile_fnc_EndTimer", FortressPlayerUnits, true];
	...
	// Spawn loot.
	[[6951.55,11338.2,0],"B_supplyCrate_F","Raid Loot Drop",true] remoteExec ["IMS_fnc_LootDrop", 0, true];
	...
	sleep 10;
	[] remoteExec ["fortessRaidObjectCleanup", 0, true];
};
