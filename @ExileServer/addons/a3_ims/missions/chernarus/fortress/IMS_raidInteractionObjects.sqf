...
fortressRaid_dokument = "Land_Document_01_F" createVehicle [6942.44, 11350, 389.843];
fortressRaid_dokument allowDamage false;
fortressRaid_dokument setPosWorld [6942.44, 11350, 389.843];
fortressRaid_dokument setVectorDirAndUp [[0.104859, -0.0314981, 0.993988], [0, 0, 1]];
...
fortressRaid_laptop = "Land_Laptop_unfolded_F" createVehicle [6909.52, 11426.5, 30.84];
fortressRaid_laptop allowDamage false;
fortressRaid_laptop setPosWorld [6909.52, 11426.5, 30.84];
fortressRaid_laptop setVectorDirAndUp [[0.187587, 0.982248, 0], [0, 0, 1]];
...
fortressRaid_terminal = "Land_DataTerminal_01_F" createVehicle [6921.73, 11387, 410.534];
fortressRaid_terminal allowDamage false;
fortressRaid_terminal setPosWorld [6921.73, 11387, 410.534];
fortressRaid_terminal setVectorDirAndUp [[0.0240458, -0.0452736, 0.998685], [0, 0, 1]];
...
fortressRaid_toilet_1 = "Land_FieldToilet_F" createVehicle [6886.2, 11423.6, 395.237];
fortressRaid_toilet_1 allowDamage false;
fortressRaid_toilet_1 setPosWorld [6886.2, 11423.6, 395.237];
fortressRaid_toilet_1 setVectorDirAndUp [[-0.0466183, -0.00932744, 0.998869], [0, 0, 1]];
...
// Gate Object.
fortressRaid_gate = "Exile_Construction_ConcreteGate_Static" createVehicle [6925.44, 11389.9, 393.79];
fortressRaid_gate allowDamage false;
fortressRaid_gate setPosWorld [6925.44, 11389.9, 393.79];
fortressRaid_gate setVectorDirAndUp [[0.555309, 0.831644, 0], [0, 0, 1]];
