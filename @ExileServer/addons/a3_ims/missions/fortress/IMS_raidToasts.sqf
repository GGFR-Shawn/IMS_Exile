...
fortressRaid_ToastBombActivated = { 
	["ErrorTitleAndText", ["<t color='#ff4242' align='center' font='PuristaSemiBold'>Bombs Activated</t>", format ["<t color='#e40000'><img align='center' image='textures\bomb.paa' size='80'/></t><br/><br/><t color='#ff4242' font='PuristaSemiBold'>Bomb detornator activated. You have 3 minutes left to leafe the fortress area!</t>"]]] call ExileClient_gui_toaster_addTemplateToast;
};
